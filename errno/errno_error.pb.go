...
func IsUserNotExists(err error) bool {
	e := errors.FromError(err)
	return e.Detail == ErrorReason_user_not_exists.String() && e.Code == 1004
}
...
func IsUserNoPasswd(err error) bool {
	e := errors.FromError(err)
	return e.Detail == ErrorReason_user_no_passwd.String() && e.Code == 1005
}
...
func IsPasswordIncorrect(err error) bool {
	e := errors.FromError(err)
	return e.Detail == ErrorReason_password_incorrect.String() && e.Code == 1006
}
